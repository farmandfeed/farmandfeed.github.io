...
function menu() {
  ...
  typewriter
    ...
    .typeString('     tomato, balsamic glaze, tahini citrus dressing (V/GF)<br>')
    .typeString('     KIMCHI SWEET POTATO CHEESE FRIES:                 $ 8.50<br>')
    .typeString('     kimchi, sweet potato fries, gochujang nacho cheese, yum yum<br>')
    .typeString('     sauce, green onion, black sesame seed (VGN)<br>')
    ...
    .typeString('     24hr beef brisket or impossible sausage (V), spicy hoisin,<br>') 
    ...
    .typeString('     pickled red onion, bonito (V)<br><br>')
    ...
    .typeString('     vanilla bean ice cream (V)<br>')
