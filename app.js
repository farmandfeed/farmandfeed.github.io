...
function menu() {
  ...
  typewriter
    ...
    .typeString('     3 chicken tinga tacos on corn tortilla with cilantro, onion<br>')
    .typeString('     shredded cabbage, queso fresco and lime<br><br>')
    ...
    .typeString('     pickles, fries. vegan available<br><br>')
    ...
    .typeString('     buttermilk fried chicken thigh, sweet+spicy gochujang glaze,<br>')
    ...
    .typeString('     cavatappi pasta, cheddar cheese, crispy panko topping, chive<br>')
    .typeString('      +$2.50 for 24hr brisket with dr pepper, bbq sauce, <br><br>')
    .typeString('     GRILLED CHEESE:                                   $11.00<br>')
    .typeString('     pickled red onion, cheddar, mozzarella, country loaf,fries<br>')
    .typeString('     +$2 for soy braised pulled pork<br><br>')
    ...
    .typeString('     mixed greens, balsamic roasted beets, green beans, avocado,<br>')
    .typeString('     shallot, crumbled bacon, alfalfa sprouts, grilled lemon<br>')
    .typeString('     thyme chicken thigh with roasted beet vinaigrette<br><br>')
