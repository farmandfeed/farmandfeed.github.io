...
function menu() {
  ...
  typewriter
    ...
    .typeString('DEVILED EASTER EGGS: kewpie mayo, togarashi, sweet and spicy gochujang bacon<br><br>')
    ...
    .typestring('HOT FISH SANDO: buttermilk fried atlantic cod, sichuan chile oil, vinegar slaw, pickles, yuzu kosho mayo, potato bun, fries<br>')
    .typestring('HOT CHICKEN SANDWICH: buttermilk fried chicken, vinegar slaw, potato bun, fries<br><br>')
    .typestring('SEASONAL POWER-UP - The RUSH Hour: rice paper crisps, ahi tuna, salmon, cucumber, avocado, mango, edamame, spicy chili aioli <br>')
...
function reserve() {
  ...
  typewriter
    ...
    .pauseFor(300)
    .typeString('    <a href="https://www.sevenrooms.com/reservations/farmfeed?duration-picker=true">RESERVE GAMING+FOOD+DRINK</a><br>')
