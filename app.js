...
function menu() {
  ...
  typewriter
    ...
    .typeString('     kewpie mayo, togarashi, sweet and spicy gochujang bacon<br>')
    .typeString('     GRILLED PORK / IMPOSSIBLE SAUSAGE LETTUCE CUPS:   $10.25<br>') 
    .typeString('     pork collar or impossible sausage,<br>')
    .typeString('     nam prik noom, pickled cucumber<br>')
    ...
    .typeString('     strawberry nigori, calvados, strawberry puree, egg white<br>')
    ...
    .typeString('     new amsterdam gin, blue curacao, grenadine, tonic, cherry<br>')
    .typeString('     HARD RESET                                        $12.00<br>')
    .typeString('     titos, lime juice, mint ginger syrup, ginger beer<br>')
    .typeString('     RAD WATER                                         $10.00<br>')
    .typeString('     espolon silver, lime juice, club soda, pink grapefuit soda<br>')
    .typeString('     PALEBLOOD                                         $10.00<br>')
    .typeString('     titos, creme de Violet, lemon juice, lavendar simple syrup<br>')
    ...
    .typeString('     coors light, bud light, michelob ultra, modelo, dos equis<br>')
    .typeString('     corona, guiness, angry orchard, truly strawberry lemonade<br><br>')
