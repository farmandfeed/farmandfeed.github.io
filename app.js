...
function events() {
  ...
  typewriter
    ...
    .typeString('Every Monday night starting Monday, 7:00pm<br>')
    .typeString('Commander deck $5 entry, which includes 1 pack/round<br>')
    .typeString('up to 2 packs. 2x 90min games. Winner of round gets either<br>')
    .typeString('an additional pack or Dragonshield card sleeves 100ct, while<br>')
    ...
    .typeString('ADVENTURERS\' GUILD - DND 4th WEDNESDAY OF EVERY MONTH<br>')
