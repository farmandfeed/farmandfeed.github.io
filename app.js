...
function menu() {
  ...
  typewriter
    ...
    .typeString('     fresh orange juice, fever tree tonic<br><br>')
    ...
    .typeString('     house grenadine<br><br>')
    ...
    .typeString('     fresh lemon juice, mint, topped with fever tree grapefruit soda<br><br>')
