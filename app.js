...
function menu() {
  ...
  typewriter
    ...
    .typeString('     tomato, balsamic glaze, tahini citrus dressing<br>')
    ...
    .typeString('     sauce, green onion, black sesame seed<br>')
    ...
    .typeString('     mango, edamame, spicy chili aioli, sesame seed<br>')
    .typeString('     GRILLED THAI SHRIMP SALAD:                        $15.00<br>')
    .typeString('     grilled shrimp, mango, avocado, charred jalapeno, grilled<br>')
    .typeString('     zucchini, thai basil, mint, thai chili vinaigrette<br>')
    ...
    .typeString('     vanilla bean ice cream<br>')
