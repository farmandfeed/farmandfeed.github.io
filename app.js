...
function menu() {
  ...
  typewriter
    ...
    .typeString('     angostura bitters,<br>')
    .typeString('     GOLDSHIRE                                         $12.00<br>')
    .typeString('     new amsterdam gin, fresh lemon juice, mint, house ginger<br>')
    .typeString('     syrup, honey, topped with brut<br>')
    .typeString('     ERDTREE FLOWER                                    $12.00<br>')
    .typeString('     bombay sapphire east gin, saint germain elderflower liqueur<br>')
    .typeString('     fresh orange juice, fever tree tonic<br>')
    .typeString('     HARD RESET                                        $10.00<br>')
    .typeString('     tito\'s, fresh lime juice, mint, ginger syrup, ginger beer<br>')
    .typeString('     RAD WATER                                         $10.00<br>')
    .typeString('     luzanul tequila, fresh lemon juice, house hibiscus syrup,<br>')
    .typeString('     topped with fever tree grapefruit soda<br>')
    .typeString('     D. VARITA                                         $12.00<br>')
    .typeString('     hibiscus flower + togarashi rim, painted donkey blanco tequila<br>')
    .typeString('     house hibiscus syrup, triple sec, fresh lime and orange juice<br><br>')
    .typeString('<u>NUKED CLASSICS </u><br>')
    .typeString('     KIRBY\'S DRINKLAND                                $12.00<br>')
    .typeString('     house yogurt jinro soju, house strawberry puree + simple<br>')
    .typeString('     egg white, fresh lemon juice<br>')
    .typeString('     PALEBLOOD                                         $10.00<br>')
    .typeString('     tito\'s, dolfi creme de violet, lemon, house lavendar syrup<br>')
    .typeString('     house grenadine<br>')
    .typeString('     GILLIONAIRE                                       $12.00<br>')
    .typeString('     dewar\'s white label, fresh oj, maple syrup, egg white<br>')
    .typeString('     chocolate bitters<br>')
    .typeString('     RUBY REDEMPTION                                   $10.00<br>')
    .typeString('     tito\'s, st germain elderflower liqueur, giffard\'s orgeat<br>')
    .typeString('     fresh lemon juice, mint, topped with fever tree grapefruit soda<br>')
    .typeString('     CORRUPTION                                        $12.00<br>')
    .typeString('     montelobos mezcal, novo cachaca, lemon bitters, agave<br>')
